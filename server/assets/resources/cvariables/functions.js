var StepFunctions = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    initcallback();
    function declareaandinitializeavariable($step) {
        highlightcode($step);
    }
    function declareavariable($step) {
        highlightcode($step);
    }
    function initializeavariable($step) {
        highlightcode($step);
    }
    function declareainitializeavariable($step) {
        initcode($step);
        highlightcode($step);
    }
    function arithmeticoperators($step) {
        initcode($step);
        highlightcode($step);
    }
    function chaining($step) {
        initcode($step);
        highlightcode($step);
    }
    function userinput($step) {
        initcode($step);
        highlightcode($step);
    }
    function challengetemperature1($step) {
        initcode($step);
        highlightcode($step);
    }
    function challengetemperature2($step) {
        initcode($step);
        highlightcode($step);
    }
    ...
    function additionalquestions($step) {
        initcode($step);
        highlightcode($step);
    }
    function test($step) {
    ...
    function introdutedatatype($step) {
    ...
    exports.challengetemperature1 = challengetemperature1;
    exports.challengetemperature2 = challengetemperature2;
    exports.declareaandinitializeavariable = declareaandinitializeavariable;
    exports.declareainitializeavariable = declareainitializeavariable;
    exports.declareavariable = declareavariable;
    exports.initializeavariable = initializeavariable;
    exports.introdutedatatype = introdutedatatype;
