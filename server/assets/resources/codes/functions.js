var StepFunctions = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    let CodeBox = class CodeBox extends CustomElementView {
        constructor() {
            super(...arguments);
            this.plainText = '';
            this.$inputChars = [];
            ...
            for (const char of str.split('')) {
                if (!char.match(/[a-zA-Z0-9]/)) {
                    ...
                    if (force || this.$inputChars[i].text !== char) {
                        ...
                        if (this.encodeFn)
                            this.encodeFn(char, this.$outputChars[i]);
                    }
                    i += 1;
                }
            }
            if (caret > 0)
                setCaretOffset(this.$input, caret);
        }
        encode(fn) {
            this.encodeFn = fn;
    ...
    let Barcode = class Barcode extends CustomElementView {
        constructor() {
            super(...arguments);
            this.left = 0;
        }
        ready() {
            this.$svg = $N('svg', { viewBox: '0 0 400 200' }, this);
    ...
    // =============================================================================
    let Enigma = class Enigma extends CustomElementView {
        constructor() {
            super(...arguments);
            this.$lights = {};
        }
    ...
    // ============================================================================
    let Morse = class Morse extends CustomElementView {
        constructor() {
            super(...arguments);
            this.value = [];
        }
    ...
    function intro($step) {
        ...
        loadScript('https://w.soundcloud.com/player/api.js').then(() => {
            ...
            widget.bind('play', () => {
                if (!hasSeenHint)
                    setTimeout(() => $step.addHint('song'), 5000);
    ...
    function dec2bin($section) {
        ...
        // timing constants
        const DURATION1 = 400, DURATION2 = 400;
        // values for N=25
        ...
        function lowerClaw(digitIndex, grabbed) {
            ...
            const $arm = $claw.$('rect');
            $arm.animate({ transform: ['none', `scale(1.0, ${ARM_Y_SCALE})`] }, DURATION1, grabbed ? 0 : DURATION2);
        ...
        function raiseClaw(digitIndex, grabbed) {
            const $claw = $digitClaws[digitIndex];
            const $grab = $claw.$('path');
            $grab.animate({ transform: [`translate(0px, ${CLAW_END_Y - CLAW_START_Y}px)`, 'none'] }, DURATION1);
            const $arm = $claw.$('rect');
        ...
        function splitBlock(digitIndex, N) {
            ...
            // change width
            (_a = $blockN.$('rect')) === null || _a === void 0 ? void 0 : _a.setAttr('width', newN * 10);
    ...
    function finger5($section) {
        ...
        (_a = $section.$('.appear')) === null || _a === void 0 ? void 0 : _a.on('click', () => $fingers.forEach($f => $f.enter('slide', 500, i++ * delay)));
    ...
    function finger32($section) {
        ...
        (_b = $section.$('.switch')) === null || _b === void 0 ? void 0 : _b.on('click', () => {
    ...
    function binaryTable($section) {
        ...
        function colour(x) {
            var _a, _b;
            (_a = $section.$('.number-grid')) === null || _a === void 0 ? void 0 : _a.children.forEach(c => {
                c.removeClass('purple-yellow');
                c.removeClass('green-yellow');
            });
            (_b = $section.$('.number-grid')) === null || _b === void 0 ? void 0 : _b.removeClass('green-yellow');
    ...
    exports.binarySimulation = binarySimulation;
    exports.binaryTable = binaryTable;
    exports.bracket = bracket;
    exports.dec2bin = dec2bin;
    exports.finger32 = finger32;
    exports.finger5 = finger5;
    exports.flashlight = flashlight;
    exports.intro = intro;
    exports.morseApplications = morseApplications;
    exports.morseEncoding = morseEncoding;
    exports.radio = radio;
