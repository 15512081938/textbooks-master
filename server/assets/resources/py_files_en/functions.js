var StepFunctions = (function (exports) {
    ...
    function initidehint($step) {
        current_step = $step;
    }
    function showCorrectHint(idmsg) {
        if (current_step != undefined) {
            current_step.addHint(idmsg, { force: true });
        }
    }
    function showIncorrectHint(idmsg) {
        if (current_step != undefined) {
    ...
    ***************************************************************************** */
    ...
    function iteratingthroughlines($step) {
        initcode($step);
        highlightcode($step);
    }
    function readingaline($step) {
        initcode($step);
        highlightcode($step);
    }
    function writingaline($step) {
        initcode($step);
        highlightcode($step);
    }
    function appendingtoafile($step) {
        initcode($step);
        highlightcode($step);
    }
    function whatiswithwith($step) {
        initcode($step);
        highlightcode($step);
    }
    function whatisacsvfile($step) {
        initcode($step);
        highlightcode($step);
    }
    function readingacsvfile($step) {
        initcode($step);
        highlightcode($step);
    }
    function readingdifferenttypesofcsvfiles($step) {
        initcode($step);
        highlightcode($step);
    }
    function writingacsvfile($step) {
        initcode($step);
        highlightcode($step);
    }
    function readingajsonfile($step) {
        initcode($step);
        highlightcode($step);
    }
    function writingajsonfile($step) {
        initcode($step);
        highlightcode($step);
    }
    ...
    function freeformproject($step) {
        initcode($step);
        highlightcode($step);
    }

    exports.appendingtoafile = appendingtoafile;
    exports.freeformproject = freeformproject;
    exports.iteratingthroughlines = iteratingthroughlines;
    exports.readingacsvfile = readingacsvfile;
    exports.readingafile = readingafile;
    exports.readingajsonfile = readingajsonfile;
    exports.readingaline = readingaline;
    exports.readingdifferenttypesofcsvfiles = readingdifferenttypesofcsvfiles;
    exports.review = review;
    exports.whatisacsvfile = whatisacsvfile;
    exports.whatiswithwith = whatiswithwith;
    exports.writingacsvfile = writingacsvfile;
    exports.writingajsonfile = writingajsonfile;
    exports.writingaline = writingaline;
