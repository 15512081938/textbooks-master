var StepFunctions = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    // =============================================================================
    let Relation = class Relation extends CustomElementView {
        constructor() {
            super(...arguments);
            this.lastWidth = 0;
            this.inputTargets = [];
        ...
        resize() {
            ...
            this.inputTargets = this.$inputs.map($i => {
                ...
                return new Point(inputBox.left + inputBox.width - box.left, inputBox.top + inputBox.height / 2 - box.top);
            });
            this.outputTargets = this.$outputs.map($o => {
                const outputBox = $o.bounds;
                return new Point(outputBox.left - box.left, outputBox.top + outputBox.height / 2 - box.top);
            });
    ...
    // =============================================================================
    function fnSketch($step) {
        $step.$('.btn.clear').on('click', () => {
            $step.$('x-coordinate-sketch').clear();
        });
    }
    //# sourceMappingURL=functions.js.map

    exports.fnSketch = fnSketch;
