var StepFunctions = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  //# sourceMappingURL=double-pendulum.js.map
  ...
  //# sourceMappingURL=pool-table.js.map
  ...
  //# sourceMappingURL=water-ripples.js.map

  // =============================================================================
  // -----------------------------------------------------------------------------
  // Introduction
  function pendulum($step) {
  ...
  function doublePendulum($step) {
      ...
      function showPendulums() {
          ...
          for (const $p of $geopad.$$('path.thick'))
              $p.show();
      }
      ...
      $play.on('play', () => {
          ...
          if (showAll)
              setTimeout(() => $step.score('play2'), 8000);
          for (const p of pendulums)
              p.set(model.d1, model.d2);
          ...
          sim.play((dt) => { for (const p of pendulums)
              p.step(dt); }, 0.1125, 3);
      });
      $play.on('pause', () => {
          $step.score('play1');
  ...
  const butterfly2 = videoPlay;
  const dominoes = videoEnd;
  const applications = videoPlay;
  const popCulture = videoPlay;
  // -----------------------------------------------------------------------------
